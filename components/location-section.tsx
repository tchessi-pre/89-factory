...
export function LocationSection() {
	return (
		<section id='location' className='relative py-20 md:py-32 overflow-hidden'>
			...
			<div className='relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
				...
				<div className='grid lg:grid-cols-2 gap-12 items-center'>
					...
					<div className='relative aspect-video lg:aspect-square rounded-3xl overflow-hidden bg-ui-white/5 border border-ui-white/10 shadow-[0_18px_60px_rgba(0,0,0,0.25)]'>
						<a
							href='https://www.google.com/maps/dir/?api=1&destination=47%20Cr%20Belsunce%2C%2013001%20Marseille'
							target='_blank'
							rel='noopener noreferrer'
							className='absolute top-4 right-4 z-20 rounded-xl bg-ui-white/15 backdrop-blur-md border border-ui-white/10 px-4 py-2 text-sm font-black tracking-wide text-ui-white hover:bg-ui-white/20 transition-colors'
						>
							Itinéraire →
						</a>
						<iframe
					...
					<div className='space-y-8'>
						...
						<div className='p-8 bg-ui-white/10 backdrop-blur-sm border border-ui-white/10 rounded-3xl shadow-menu'>
							<div className='flex items-start gap-4 mb-6'>
								...
								<div>
									<h3 className='text-2xl font-black text-ui-white mb-2 tracking-tight'>
							...
							<div className='flex items-start gap-4 mb-6'>
								...
								<div>
									<h3 className='text-xl font-black text-ui-white mb-2 tracking-tight'>
										Tous les jours !
									</h3>
									<p className='text-ui-white/75'>
										Venez nous voir tous les jours pour des burgers frais et
										plus encore
									</p>
								</div>
							</div>
						...
						<div className='p-6 bg-ui-white/10 backdrop-blur-sm border border-ui-white/10 rounded-3xl shadow-menu'>
							<h4 className='text-xl font-black text-pink-light mb-2 tracking-tight'>
								Soirées, événements & festivals
							</h4>
							<p className='text-ui-white/80'>
								Nous assurons aussi le service traiteur pour vos événements
								privés ! Contactez-nous pour des offres sur mesure.
							</p>
						</div>
					</div>
				</div>
